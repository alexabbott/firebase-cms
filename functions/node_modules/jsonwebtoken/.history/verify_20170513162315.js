...
module.exports = function (jwtString, secretOrPublicKey, options, callback) {
  ...
  if (options.maxAge) {
    ...
    var maxTimestamp = timespan(options.maxAge, clockTimestamp);
    if (clockTimestamp >= maxTimestamp + (options.clockTolerance || 0)) {
      return done(new TokenExpiredError('maxAge exceeded', maxTimestamp));
    }
  }
