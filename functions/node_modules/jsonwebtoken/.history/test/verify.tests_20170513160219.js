  ...
  describe.only('expiration', function () {
    ...
    describe('option: maxAge', function () {
      ...
      it('should error using numeric maxAge when max age was exceeded', function(done) {
        // { foo: 'bar', iat: 1437018582, exp: 1437018182 }
        // time passed: 15s = 1437018597000
        var token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmb28iOiJiYXIiLCJpYXQiOjE0MzcwMTg1ODIsImV4cCI6MTQzNzAxODE4Mn0.NzxiM1KNk1K5q44jKuwvRIiWdZ2fb9m4a8gn11vR3HM';
