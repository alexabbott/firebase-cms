...
describe('verify', function() {
  ...
  describe('expiration', function () {
    ...
    describe('option: maxAge', function () {
      ...
      [new String('1s'), 'wrong'].forEach(function (maxAge){
        it.only(`should error if maxAge is specified with a wrong string format (value: ${maxAge}, type: ${typeof maxAge})`, function (done) {
          clock = sinon.useFakeTimers(1437018587000); // iat + 5s, exp - 5s
          var options = { algorithms: ['HS256'], maxAge: 'wrong' };
